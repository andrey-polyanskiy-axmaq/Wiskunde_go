...
func TestRepository_PostReservation(t *testing.T) {
	...
	postedData.Add("phone", "555-444-3322")
	...
	handler.ServeHTTP(rr, req)
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("PostReservation handler failed when inserting the reservation: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	}
